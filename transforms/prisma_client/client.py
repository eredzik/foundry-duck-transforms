...
SCHEMA_PATH = Path('/home/emil/projects/foundry-duck-transforms/transforms/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-1.1.x': '/home/emil/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-debian-openssl-1.1.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    dataset_identifier: 'actions.dataset_identifierActions[models.dataset_identifier]'
    dataset_version: 'actions.dataset_versionActions[models.dataset_version]'
    data_branch: 'actions.data_branchActions[models.data_branch]'
    ...
    def __init__(
        ...
        *,
        ...
        self.dataset_identifier = actions.dataset_identifierActions[models.dataset_identifier](self, models.dataset_identifier)
        self.dataset_version = actions.dataset_versionActions[models.dataset_version](self, models.dataset_version)
        self.data_branch = actions.data_branchActions[models.data_branch](self, models.data_branch)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/home/emil/projects/foundry-duck-transforms/transforms/schema.prisma',
        }
...
class Batch:
    ...
    dataset_identifier: 'dataset_identifierBatchActions'
    dataset_version: 'dataset_versionBatchActions'
    data_branch: 'data_branchBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.dataset_identifier = dataset_identifierBatchActions(self)
        self.dataset_version = dataset_versionBatchActions(self)
        self.data_branch = data_branchBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class dataset_identifierBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
    ...
    def create(
        ...
        self._batcher._add(
            method='create',
            model=models.dataset_identifier,
            arguments={
                'data': data,
                'include': include,
            },
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class dataset_versionBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
